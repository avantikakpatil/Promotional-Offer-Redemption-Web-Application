  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-600 mt-2">Track all voucher redemptions processed at your store</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Unique Resellers</p>
              <p className="text-2xl font-bold text-gray-900">{new Set(redemptionHistory.map(item => item.resellerId)).size}</p>
            </div>
          </div>
        </div>
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{redemption.points} points</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                ...
                <div>
                  ...
                  {redemption.resellerId && (
                    <p className="text-sm text-gray-600">Reseller ID: {redemption.resellerId}</p>
                  )}
                </div>
              </div>
